...
Comprehensive financial analysis of Germany's 12 largest companies focusing on:

* Financial performance indicators (Revenue, Net Income, ROA, ROE)
* Balance sheet structure and debt-to-equity ratio
* Temporal trends and developments (2017-2024)
* Industry comparisons and company profiles
* Risk assessment and financial stability

## 📦 Dataset

**Data Source:** [Top 12 German Companies - Kaggle](https://www.kaggle.com/datasets/willianoliveiragibin/top-12-german-companies)

**384 observations** with 11 financial metrics per company
...
**Financial Metrics:** Revenue, Net Income, Liabilities, Assets, Equity, ROA, ROE, Debt-to-Equity Ratio

## 🔍 Key Findings

### 📈 Conclusion 1 – Average Financial Metrics

✅ **Merck KGaA** leads in revenue and net income, but shows high leverage  
✅ **BASF SE** demonstrates strong equity structure and balance sheet stability  
...
### 📊 Conclusion 2 – Trend Analysis (2017-2024)

✅ **Volkswagen AG:** Recovery after 2020 pandemic, declining debt-to-equity ratio  
✅ **BMW AG:** Continuous upward trend with controlled leverage  
